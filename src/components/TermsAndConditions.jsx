  ...
  return (
    <div className={`max-w-4xl mx-auto p-6 space-y-6 ${isDark ? "text-black bg-white":"text-white bg-gray-800"}`}>
      ...
      <section>
        ...
        <p>If you have any questions about these Terms and Conditions, please contact us at <a href="mailto:fahiiraza8@gmail.com" className="text-blue-500 underline">fahiiraza8@gmail.com</a>.</p>
      </section>
